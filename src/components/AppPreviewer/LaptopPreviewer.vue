...
import PreviewerModeSwitcher from './PreviewerModeSwitcher.vue';
import BlockRender from '@/blocks/BlockRenderer.vue'
...
<template>
  <div class="layout-runner">
    <div class="layout-runner-navigator">
      <div></div>
      <div class="address-wrapper">https://helloword.com/sdfsfsdf/sggwefwfsdfsdfsdfsdfsf
      </div>
      <PreviewerModeSwitcher
